        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="p-6 text-gray-900 dark:text-gray-100 font-bold">
                    {{ __("Crear un Nuevo Proyecto") }}
                </div>

                
                <form action="{{ route('projects.store') }}" method="POST" class="grid">
                    @csrf
                    <label for="" class="mt-3">Nombre del Proyecto</label>
                    <input type="text" name="proyecto" style="width: 25%;">
                
                    <label for="" class="mt-3">Nombre de la Fuente</label>
                    <input type="text" name="fuente" style="width: 25%;">
                
                    <label for="" class="mt-3">Monto Planificado</label>
                    <input type="text" name="mPlanificado" style="width: 25%;">
                
                    <label for="" class="mt-3">Monto Patrocinado</label>
                    <input type="text" name="mPatrocinado" style="width: 25%;">
                
                    <label for="" class="mt-3">Monto de los Fondos</label>
                    <input type="text" name="mFondos" style="width: 25%;">
